<template>
  <ul class="honeycomb" lang="es">
    <li class="honeycomb-cell" v-for="project in projects" :key="project.name">
      <img class="honeycomb-cell__image" :src="project.src" />
      <div class="honeycomb-cell__title"> {{ project.name }} </div>
    </li>
